  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '80px 48px 120px' }}>
      ...
      <div className="prose-wls">
        ...
        <h2>Contact</h2>
        <p>
          If you have questions about this cookie policy or how we handle data, you can contact us at <a href="mailto:contact@worldlegalservices.com">contact@worldlegalservices.com</a>.
        </p>
      </div>
