...
export const pillars: Pillar[] = [
  {
    ...
    articles: [
      ...
      { slug: "the-stability-property", number: "Founding Document · VI", title: "The Stability Property: Architectural Requirements for Non-Corruptible AI Agents", excerpt: "Why governance AI must reject everything commercial AI was built for — and the architecture that follows from that inversion." },
    ],
  },
  {
    id: "robotics-law",
